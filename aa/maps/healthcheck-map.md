...
| --- | --- | --- | --- | --- |
| HC-001 | cmdbwebhooks2kafka | `GET http://localhost:5080/health`, из Docker `GET http://192.168.202.100:5080/health` | `{"service":"cmdbwebhooks2kafka-dev","status":"ok"}` | Готовность приема webhook от CMDBuild |
