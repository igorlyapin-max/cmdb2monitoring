...
Для всех сетевых соединений в артефактах указываются порты, если они известны. В dev-контуре CMDBuild вызывает webhook на `http://192.168.202.35:5080/webhooks/cmdbuild`, а `cmdbwebhooks2kafka` слушает `0.0.0.0:5080`.
