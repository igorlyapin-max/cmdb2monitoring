...
Текущая версия описывает dev-контур и целевую структуру для тест/прод, включая Mapping edit/delete workflow в `monitoring-ui-api`. Kafka topics создаются внешней инфраструктурой, микросервисы topics не создают.
