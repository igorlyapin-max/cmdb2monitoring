...
| `Services:HealthEndpoints` | Health endpoints микросервисов; для `cmdbkafka2zabbix` дополнительно `RulesReloadUrl`, `RulesReloadToken`, `RulesStatusUrl`, `RulesStatusToken` | При добавлении сервисов, reload-действий или read-only статуса правил |
