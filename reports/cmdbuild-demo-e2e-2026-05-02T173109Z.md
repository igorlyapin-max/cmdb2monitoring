...
Generated: 2026-05-02T17:31:09.586Z
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| cmdb-c2mtestci-c2m-demo-001-scalar | cmdb-c2mtestci-c2m-demo-001-scalar | C2MTestCI C2M-DEMO-001-SCALAR | scalar source field | present | monitored (0) | 10.20.1.10 (type 1) | Linux servers (2) | Linux by Zabbix agent (10001)<br>ICMP Ping (10564) | {$CMDB_CLASS}=C2MTestCI<br>{$CMDB_ID}=219799<br>{$C2M_DEMO_CODE}=C2M-DEMO-001-SCALAR | alias=C2M-DEMO-001-SCALAR<br>asset_tag=219799 | connect=1<br>accept=1 | source=cmdbuild<br>cmdb.class=C2MTestCI<br>cmdb.id=219799<br>cmdb.event=create<br>cmdb.hostProfile=main |
| cmdb-c2mtestci-c2m-demo-002-lookup | cmdb-c2mtestci-c2m-demo-002-lookup | C2MTestCI C2M-DEMO-002-LOOKUP | lookup source field and business-hours policy tag | present | monitored (0) | 10.20.2.10 (type 1) | Linux servers (2) | Linux by Zabbix agent (10001)<br>ICMP Ping (10564) | {$CMDB_CLASS}=C2MTestCI<br>{$CMDB_ID}=219806<br>{$C2M_DEMO_CODE}=C2M-DEMO-002-LOOKUP | alias=C2M-DEMO-002-LOOKUP<br>asset_tag=219806 | connect=1<br>accept=1 | source=cmdbuild<br>cmdb.class=C2MTestCI<br>cmdb.id=219806<br>cmdb.event=create<br>cmdb.hostProfile=main<br>monitoring.policy=business_hours_08_18 |
| cmdb-c2mtestci-c2m-demo-003-reference-leaf | cmdb-c2mtestci-c2m-demo-003-reference-leaf | C2MTestCI C2M-DEMO-003-REFERENCE-LEAF | reference leaf interface | present | monitored (0) | 10.20.3.1 (type 1)<br>10.20.3.10 (type 2) | Linux servers (2) | HP iLO by SNMP (10256) | {$CMDB_CLASS}=C2MTestCI<br>{$CMDB_ID}=219813<br>{$C2M_DEMO_CODE}=C2M-DEMO-003-REFERENCE-LEAF | alias=C2M-DEMO-003-REFERENCE-LEAF<br>asset_tag=219813 | connect=1<br>accept=1 | source=cmdbuild<br>cmdb.class=C2MTestCI<br>cmdb.id=219813<br>cmdb.event=create<br>cmdb.hostProfile=main |
| cmdb-c2mtestci-c2m-demo-004-deep-reference | cmdb-c2mtestci-c2m-demo-004-deep-reference | C2MTestCI C2M-DEMO-004-DEEP-REFERENCE | deep reference leaf and lookup tag | present | monitored (0) | 10.20.4.1 (type 1)<br>10.20.4.20 (type 2) | Linux servers (2) | HP iLO by SNMP (10256) | {$CMDB_CLASS}=C2MTestCI<br>{$CMDB_ID}=219824<br>{$C2M_DEMO_CODE}=C2M-DEMO-004-DEEP-REFERENCE | alias=C2M-DEMO-004-DEEP-REFERENCE<br>asset_tag=219824 | connect=2<br>accept=2 | source=cmdbuild<br>cmdb.class=C2MTestCI<br>cmdb.id=219824<br>cmdb.event=create<br>cmdb.hostProfile=main<br>cmdb.deepReference.lookup=production |
| cmdb-c2mtestci-c2m-demo-005-domain-single | cmdb-c2mtestci-c2m-demo-005-domain-single | C2MTestCI C2M-DEMO-005-DOMAIN-SINGLE | single domain relation leaf | present | monitored (0) | 10.20.5.1 (type 1)<br>10.20.5.10 (type 2) | Linux servers (2) | HP iLO by SNMP (10256) | {$CMDB_CLASS}=C2MTestCI<br>{$CMDB_ID}=219839<br>{$C2M_DEMO_CODE}=C2M-DEMO-005-DOMAIN-SINGLE | alias=C2M-DEMO-005-DOMAIN-SINGLE<br>asset_tag=219839 | connect=1<br>accept=1 | source=cmdbuild<br>cmdb.class=C2MTestCI<br>cmdb.id=219839<br>cmdb.event=create<br>cmdb.hostProfile=main |
| cmdb-c2mtestci-c2m-demo-006-domain-multi | cmdb-c2mtestci-c2m-demo-006-domain-multi | C2MTestCI C2M-DEMO-006-DOMAIN-MULTI | domain relation collection with collectionMode=first | present | monitored (0) | 10.20.6.1 (type 1)<br>10.20.6.10 (type 2) | Linux servers (2) | HP iLO by SNMP (10256) | {$CMDB_CLASS}=C2MTestCI<br>{$CMDB_ID}=219867<br>{$C2M_DEMO_CODE}=C2M-DEMO-006-DOMAIN-MULTI | alias=C2M-DEMO-006-DOMAIN-MULTI<br>asset_tag=219867 | connect=1<br>accept=1 | source=cmdbuild<br>cmdb.class=C2MTestCI<br>cmdb.id=219867<br>cmdb.event=create<br>cmdb.hostProfile=main |
| cmdb-c2mtestci-c2m-demo-007-multi-ip-same-host | cmdb-c2mtestci-c2m-demo-007-multi-ip-same-host | C2MTestCI C2M-DEMO-007-MULTI-IP-SAME-HOST | multiple IPs as interfaces[] in one host | present | monitored (0) | 10.20.7.10 (type 1)<br>10.20.7.11 (type 2)<br>10.20.7.12 (type 2) | Linux servers (2) | HP iLO by SNMP (10256) | {$CMDB_CLASS}=C2MTestCI<br>{$CMDB_ID}=219888<br>{$C2M_DEMO_CODE}=C2M-DEMO-007-MULTI-IP-SAME-HOST | alias=C2M-DEMO-007-MULTI-IP-SAME-HOST<br>asset_tag=219888 | connect=1<br>accept=1 | source=cmdbuild<br>cmdb.class=C2MTestCI<br>cmdb.id=219888<br>cmdb.event=create<br>cmdb.hostProfile=main |
| cmdb-c2mtestci-c2m-demo-008-separate-profiles | cmdb-c2mtestci-c2m-demo-008-separate-profiles | C2MTestCI C2M-DEMO-008-SEPARATE-PROFILES | base host for separate monitoring profiles | present | monitored (0) | 10.20.8.10 (type 1) | Linux servers (2) | Linux by Zabbix agent (10001)<br>ICMP Ping (10564) | {$CMDB_CLASS}=C2MTestCI<br>{$CMDB_ID}=219895<br>{$C2M_DEMO_CODE}=C2M-DEMO-008-SEPARATE-PROFILES | alias=C2M-DEMO-008-SEPARATE-PROFILES<br>asset_tag=219895 | connect=1<br>accept=1 | source=cmdbuild<br>cmdb.class=C2MTestCI<br>cmdb.id=219895<br>cmdb.event=create<br>cmdb.hostProfile=main |
| cmdb-c2mtestci-c2m-demo-008-separate-profiles-separate-profile-1 | cmdb-c2mtestci-c2m-demo-008-separate-profiles-separate-profile-1 | C2MTestCI C2M-DEMO-008-SEPARATE-PROFILES separate profile 1 | first separate Zabbix host profile | present | monitored (0) | 10.20.8.21 (type 2) | Discovered hosts (5) | Generic by SNMP (10563) | {$CMDB_CLASS}=C2MTestCI<br>{$CMDB_ID}=219895<br>{$C2M_DEMO_CODE}=C2M-DEMO-008-SEPARATE-PROFILES | alias=C2M-DEMO-008-SEPARATE-PROFILES<br>asset_tag=219895 | connect=1<br>accept=1 | source=cmdbuild<br>cmdb.class=C2MTestCI<br>cmdb.id=219895<br>cmdb.event=create<br>cmdb.hostProfile=separate-profile-1 |
| cmdb-c2mtestci-c2m-demo-008-separate-profiles-separate-profile-2 | cmdb-c2mtestci-c2m-demo-008-separate-profiles-separate-profile-2 | C2MTestCI C2M-DEMO-008-SEPARATE-PROFILES separate profile 2 | second separate Zabbix host profile | present | monitored (0) | 10.20.8.22 (type 2) | Discovered hosts (5) | Generic by SNMP (10563) | {$CMDB_CLASS}=C2MTestCI<br>{$CMDB_ID}=219895<br>{$C2M_DEMO_CODE}=C2M-DEMO-008-SEPARATE-PROFILES | alias=C2M-DEMO-008-SEPARATE-PROFILES<br>asset_tag=219895 | connect=1<br>accept=1 | source=cmdbuild<br>cmdb.class=C2MTestCI<br>cmdb.id=219895<br>cmdb.event=create<br>cmdb.hostProfile=separate-profile-2 |
| cmdb-c2mtestci-c2m-demo-010-business-hours | cmdb-c2mtestci-c2m-demo-010-business-hours | C2MTestCI C2M-DEMO-010-BUSINESS-HOURS | business-hours policy tag | present | monitored (0) | 10.20.10.10 (type 1) | Linux servers (2) | Linux by Zabbix agent (10001)<br>ICMP Ping (10564) | {$CMDB_CLASS}=C2MTestCI<br>{$CMDB_ID}=219909<br>{$C2M_DEMO_CODE}=C2M-DEMO-010-BUSINESS-HOURS | alias=C2M-DEMO-010-BUSINESS-HOURS<br>asset_tag=219909 | connect=1<br>accept=1 | source=cmdbuild<br>cmdb.class=C2MTestCI<br>cmdb.id=219909<br>cmdb.event=create<br>cmdb.hostProfile=main<br>monitoring.policy=business_hours_08_18 |
| cmdb-c2mtestci-c2m-demo-011-domain-leaf-dont-monitor | cmdb-c2mtestci-c2m-demo-011-domain-leaf-dont-monitor | C2MTestCI C2M-DEMO-011-DOMAIN-LEAF-DONT-MONITOR | domain leaf do_not_monitor does not become interface | present | monitored (0) | 10.20.11.1 (type 1) | Linux servers (2) | Linux by Zabbix agent (10001)<br>ICMP Ping (10564) | {$CMDB_CLASS}=C2MTestCI<br>{$CMDB_ID}=219923<br>{$C2M_DEMO_CODE}=C2M-DEMO-011-DOMAIN-LEAF-DONT-MONITOR | alias=C2M-DEMO-011-DOMAIN-LEAF-DONT-MONITOR<br>asset_tag=219923 | connect=1<br>accept=1 | source=cmdbuild<br>cmdb.class=C2MTestCI<br>cmdb.id=219923<br>cmdb.event=create<br>cmdb.hostProfile=main |
| cmdb-c2mtestci-c2m-demo-012-disabled-status | cmdb-c2mtestci-c2m-demo-012-disabled-status | C2MTestCI C2M-DEMO-012-DISABLED-STATUS | host status assignment from conversion rules | present | disabled (1) | 10.20.12.10 (type 1) | Linux servers (2) | Linux by Zabbix agent (10001)<br>ICMP Ping (10564) | {$CMDB_CLASS}=C2MTestCI<br>{$CMDB_ID}=219937<br>{$C2M_DEMO_CODE}=C2M-DEMO-012-DISABLED-STATUS | alias=C2M-DEMO-012-DISABLED-STATUS<br>asset_tag=219937 | connect=1<br>accept=1 | source=cmdbuild<br>cmdb.class=C2MTestCI<br>cmdb.id=219937<br>cmdb.event=create<br>cmdb.hostProfile=main |
| cmdb-c2mtestci-c2m-demo-013-dns-only | cmdb-c2mtestci-c2m-demo-013-dns-only | C2MTestCI C2M-DEMO-013-DNS-ONLY | DNS-only hostname interface | present | monitored (0) | demo-dns-only.example.test (type 1) | Linux servers (2) | Linux by Zabbix agent (10001)<br>ICMP Ping (10564) | {$CMDB_CLASS}=C2MTestCI<br>{$CMDB_ID}=219944<br>{$C2M_DEMO_CODE}=C2M-DEMO-013-DNS-ONLY | alias=C2M-DEMO-013-DNS-ONLY<br>asset_tag=219944 | connect=1<br>accept=1 | source=cmdbuild<br>cmdb.class=C2MTestCI<br>cmdb.id=219944<br>cmdb.event=create<br>cmdb.hostProfile=main |
...
| C2M-DEMO-001-SCALAR/main: inventory asset_tag matches cmdb.id | OK | 219799 |
